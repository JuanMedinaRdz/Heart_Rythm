...
class MensualidadesSouthScreen extends StatefulWidget {
  const MensualidadesSouthScreen({super.key});

  @override
  State<MensualidadesSouthScreen> createState() => _MensualidadesSouthScreenState();
}

class _MensualidadesSouthScreenState extends State<MensualidadesSouthScreen> {
  ...
  Future<void> _fetchMonthlyPayments() async {
    try {
      final snapshot =
          await FirebaseFirestore.instance.collection('studentsSouth').get();
