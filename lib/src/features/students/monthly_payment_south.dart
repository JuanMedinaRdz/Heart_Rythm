...
class MonthlyPaymentScreenSouth extends StatefulWidget {
  final String docId;
  final String studentName;

  const MonthlyPaymentScreenSouth({
    super.key,
    required this.docId,
  ...
  @override
  State<MonthlyPaymentScreenSouth> createState() => _MonthlyPaymentScreenSouthState();
}

class _MonthlyPaymentScreenSouthState extends State<MonthlyPaymentScreenSouth> {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          CircleAvatar(
            radius: 24,
            backgroundColor: AppColors.secondEnd,
            child: Text(
          ...
          child: Column(
            ...
            children: [
              ...
              LinearProgressIndicator(
                ...
                valueColor: const AlwaysStoppedAnimation<Color>(AppColors.secondEnd),
              ),
              const SizedBox(height: 8),
              Row(
                children: [
                  _buildLegendItem(AppColors.secondEnd, 'Pagado'),
                  const SizedBox(width: 16),
...
Widget _buildMonthCard(String month, bool isPaid) {
  final color = isPaid ? AppColors.secondEnd : Colors.grey[300];
